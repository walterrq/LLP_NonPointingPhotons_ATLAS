...
sed "s|FOLDER|$madgraph_folder|g" mg5_launches_muon.txt > mg5_launches_proper_muon.txt

#${madgraph_folder}/bin/mg5_aMC mg5_launches_proper.txt #> /dev/null 2>&1  
${madgraph_folder}/bin/mg5_aMC mg5_launches_proper_muon.txt #> /dev/null 2>&1
