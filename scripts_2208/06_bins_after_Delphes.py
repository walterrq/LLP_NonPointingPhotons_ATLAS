...
def main(variables):
    ...
    input_file = origin + f"full_{type}_{base_out}_photons.pickle";
...
origin = f"/Collider/scripts_2208/data/clean/vw_full/"
#origin = "/Collider/2023_LLHN_CONCYTEC/"
#We safe the documents in our host machine
destiny = f"./data/matrices_15/vw_full/"
types = ['ZH', 'WH', 'TTH']
tevs = [13]
...
bases = []
for xx in types:
    files_in = glob.glob(origin + f"full_{xx}*photons.pickle")
