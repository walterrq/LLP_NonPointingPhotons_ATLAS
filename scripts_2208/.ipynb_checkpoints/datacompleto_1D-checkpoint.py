        ...
        if len(line) > 0:
            if line[0] == 'E':
                ...
                if(es_foton_final):
                    ...
                    #print("Imprimos x,y,z,px,py,pz, mass_ph: ", x, y, z, px, py, pz, mass_ph)
                    ...
                    #if(realizar_analisis_cumple== True):
                    #    print("Pasa")
                    ...
                    if (realizar_analisis_cumple): #Si es que la particula es foton y es particula final (si no es negativo)    
                        ...
                        try:                                                        
                            ...
                            #print("Imprimos x,y,z,px,py,pz, mass_ph: ", x_n, y_n, z_n, px_n, py_n, pz_n)
