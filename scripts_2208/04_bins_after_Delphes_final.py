...
def main(variables):
    ...
    filtered_jets = jets[jets['Constituents'].apply(lambda x: x == [13])]

    print("Filtered jets")
    print(len(filtered_jets))
    
    filtered_jets2 = jets[jets['Constituents'].apply(lambda x: x == [1])]

    print("Filtered jets2")
    print(len(filtered_jets2))
    print(filtered_jets2)

    filtered_jets3 = jets[jets['Constituents'].apply(lambda x: x == [0])]

    filtered_jets_1cons = jets[jets['Constituents'].apply(lambda x: x == [13] or x == [0])]

    print("Filtered Jets New")
    print(filtered_jets_1cons)
    print(len(filtered_jets_1cons))

    print("Filtered jets3")
    print(len(filtered_jets3))
    print(filtered_jets3)

    #numberJetsCon = len(jets[jets.Constituents.[13]])
    print("Printeamos numero de jets con constituent 13")
    #print(numberJetsCon)
    ...
    muons['mujet_iso_mu_e02'] = isolation(muons, jets, 'pt', same=False, dR=0.01)
    muons['mujet_iso_mu_e03'] = isolation(muons, jets, 'pt', same=False, dR=0.2)
    muons['mujet_iso_mu_e04'] = isolation(muons, jets, 'pt', same=False, dR=0.4)
    muons['mujet_iso_mu_e05'] = isolation(muons, filtered_jets_1cons, 'pt', same=False, dR=0.01)
    muons['mujet_iso_mu_e06'] = isolation(muons, filtered_jets_1cons, 'pt', same=False, dR=0.2)
    muons['mujet_iso_mu_e07'] = isolation(muons, filtered_jets_1cons, 'pt', same=False, dR=0.4)
    # muons['mujet_iso_mu_e04'] = isolation(muons, jets, 'pt', same=False, dR=0.0001)
    # muons['mujet_iso_mu_e05'] = isolation(muons, jets, 'pt', same=False, dR=0.00001)
    # muons['mujet_iso_mu_e06'] = isolation(muons, jets, 'pt', same=False, dR=0.000001)
    # muons['mujet_iso_mu_e07'] = isolation(muons, jets, 'pt', same=False, dR=0.0000001)


    # leptons[leptons.pdg == 13]['mujet_iso_mu_e02'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.01)
    # leptons[leptons.pdg == 13]['mujet_iso_mu_e03'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.001)
    # leptons[leptons.pdg == 13]['mujet_iso_mu_e04'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.0001)
    # leptons[leptons.pdg == 13]['mujet_iso_mu_e05'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.00001)
    # leptons[leptons.pdg == 13]['mujet_iso_mu_e06'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.000001)
    # leptons[leptons.pdg == 13]['mujet_iso_mu_e07'] = isolation(leptons[leptons.pdg == 13], jets, 'pt', same=False, dR=0.0000001)
    ...
    # munumberJets0_2 = len(muons[muons['mujet_iso_mu_e02'] != 0.0])
    # munumberJets0_3 = len(muons[muons['mujet_iso_mu_e03'] != 0.0])
    # munumberJets0_4 = len(muons[muons['mujet_iso_mu_e04'] != 0.0])
    # munumberJets0_5 = len(muons[muons['mujet_iso_mu_e05'] != 0.0])
    # munumberJets0_6 = len(muons[muons['mujet_iso_mu_e06'] != 0.0])
    # munumberJets0_7 = len(muons[muons['mujet_iso_mu_e07'] != 0.0])
    ...
    print("Number of mu cone != 0 for deltaR 0.01")
    print(munumberJets0_2)

    print("Number of mu cone != 0 for deltaR 0.2")
    print(munumberJets0_3)

    print("Number of mu cone != 0 for deltaR 0.4")
    print(munumberJets0_4)

    print("Number of mu cone filt_jets != 0 for deltaR 0.01")
    print(munumberJets0_5)

    print("Number of mu cone filt_jets != 0 for deltaR 0.2")
    print(munumberJets0_6)
    
    print("Number of mu cone filt_jets != 0 for deltaR 0.4")
    print(munumberJets0_7)
    ...
    #Me estoy quedando con los electrones que no tienen particulas(jets) a un dR 0.4
