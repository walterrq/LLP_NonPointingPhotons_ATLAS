...
#! No entiendo muy bien de donde salen estos valores.
...
#todo Calculo de theta en funcion de r_gamma y z unitario
...
#todo Calculo de eta en funcion de theta
                ...
                if(es_foton_final):
                    ...
                    if (realizar_analisis_cumple): #Si es que la particula es foton y es particula final (si no es negativo)    
                        ...
                        try:                                                         
                            ...
                            R1, R2 = eta_functions_R.eta_func_R(eta1,eta2)
                            ...
                            #angletheta1 = functiontheta(time1, p_vector)

                            #print("el angulo theta1 es: ",angletheta1)

                            #eta1 = -np.log(np.tan(angletheta1))
                            sys.exit("Salimos")
